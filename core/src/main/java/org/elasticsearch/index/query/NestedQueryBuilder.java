...
public class NestedQueryBuilder extends AbstractQueryBuilder<NestedQueryBuilder> {
    ...
    protected Query doToQuery(QueryShardContext context) throws IOException {
        ...
        boolean previous = context.hasParentQueryWithInnerHits(); //set the previous hit
        ObjectMapper objectMapper = context.nestedScope().getObjectMapper();
        try {
            context.setHasParentQueryWithInnerHits(queryInnerHits != null); //set the context
            ...
            context.setHasParentQueryWithInnerHits(previous); //set context as previous
        }
        ...
        if (queryInnerHits != null) {
            try (XContentParser parser = queryInnerHits.getXcontentParser()) {
                ...
                if (innerHits != null) {
                    ...
                    //prevents addition of nested inner hits to context
